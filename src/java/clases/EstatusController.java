...
@Named("estatusController")
@SessionScoped
public class EstatusController implements Serializable {

    @EJB
    private sesiones.EstatusFacade ejbFacade;
    private List<Estatus> items = null;
    private Estatus selected;
    ...
    private EstatusFacade getFacade() {
        return ejbFacade;
    }

    public Estatus prepareCreate() {
        selected = new Estatus();
        initializeEmbeddableKey();
        return selected;
    }

    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("EstatusCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("EstatusUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("EstatusDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Estatus getEstatus(java.lang.Integer id) {
        return getFacade().find(id);
    }

    public List<Estatus> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<Estatus> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class EstatusControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getEstatus(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Estatus) {
                ...
                return getStringKey(o.getIdEstatus());
            } else {
